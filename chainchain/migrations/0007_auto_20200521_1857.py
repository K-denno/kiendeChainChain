...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('chainchain', '0006_notifications_timestamp'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='refer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
